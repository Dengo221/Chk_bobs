<?php
// api_bobs.php - v32.0 (A VERSÃO FINAL, FAZENDO O QUE VOCÊ PEDIU)

error_reporting(0);
date_default_timezone_set('America/Sao_Paulo');

// --- CONFIGURAÇÕES E FUNÇÃO CURL (INTACTAS, JÁ FUNCIONAM) ---
$site_config = [
...
// --- LÓGICA PRINCIPAL (INTACTA, JÁ FUNCIONA) ---
$lista = $_GET['lista'] ?? '';
